      ...
      <div className="flex flex-wrap justify-center gap-2 lg:gap-4">
        {categories.map(({ src, alt, label, eu }, i) => (
          <div
            ...
            className="flex-shrink-0 w-24 sm:w-48 2xl:w-52 flex flex-col items-center justify-center gap-3 bg-white rounded-2xl p-4 cursor-pointer hover:bg-secondary group transition-shadow duration-200 shadow-sm"
