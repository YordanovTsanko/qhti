    ...
    <nav className="w-full bg-white border-b-[6px] border-secondary px-6 py-4 grid grid-cols-5 md:grid-cols-3 lg:flex lg:items-center lg:justify-between relative z-20">
      ...
      <div className="flex items-center gap-4 lg:gap-8 relative justify-end lg:justify-normal">
        <div className="flex items-center space-x-2">
          ...
          {openProfile && (
            <div className="absolute top-12 right-0 bg-white shadow-custom flex flex-col z-30">
              <button
                type="button"
                onClick={() => {
              ...
              <button
                ...
                className="text-primary text-start pe-14 lg:pe-20 ps-4 py-1 font-semibold hover:text-primary/90 transition duration-300"
              >
                РЕГИСТРИРАЙ СЕ
              </button>
            </div>
